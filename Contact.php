...
<body class="u-body">
    ...
    <!--<footer class="u-align-center u-clearfix u-footer u-grey-80 u-footer" id="sec-39db"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="form">
            <form action="vprasanje_insert.php" method="post">
                <table>
                    ...
                    <tr>
                        <td><input name="naslov" style="width: 700px;" type="text"></td>
                    </tr>
                    <tr>
                        <td><br><b>Body</b></td>
                    </tr>
                    <tr>
                        <td><textarea rows="10" cols="50" name="opis" style="width: 700px;" name="Description"
