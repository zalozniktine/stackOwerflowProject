                        ...
                        <a href="profile.php"
                                ...
                                style="padding: 8px 0px;">
                                    '.$_SESSION['user_name']; if (!isset($_SESSION['image'])){
                                        echo '<img style="width:25px; height:25px; border:1px solid black" src="profile_pictures/default.png">';
                                    }else{
                                        echo
                                        '<img style="width:25px; height:25px; border:1px solid black" class="postmedia" src="'.$_SESSION['image'].'">';
                                    }'
